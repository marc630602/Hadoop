...
public class LoggerUtil {
    private static final Logger logger = Logger.getLogger(String.valueOf(LoggerUtil.class));
    private static IPSeekerEx ipSeekerExt = new IPSeekerEx();
    ...
    private static void handleIp(Map<String,String> clientInfo) {
        if (clientInfo.containsKey(EventLogConstants.LOG_COLUMN_NAME_IP)) {
            ...
            IPSeekerEx.RegionInfo info = ipSeekerExt.analyticIp(ip);
            if (info != null) {
