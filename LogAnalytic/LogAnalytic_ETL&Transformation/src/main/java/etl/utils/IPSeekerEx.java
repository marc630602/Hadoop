 ...
 *
 */
public class IPSeekerEx extends IPSeeker {
        ...
        try {
            ...
            if ("局域网".equals(country)) {
                ...
                if (index > 0) {
                    ...
                    } else if ("广西".equals(flag) || "西藏".equals(flag) || "宁夏".equals(flag) || "新疆".equals(flag)) {
                        info.setCountry("中国");
                    ...
                    } else if ("上海".equals(flag) || "北京".equals(flag) || "天津".equals(flag) || "重庆".equals(flag)) {
                        info.setCountry("中国");
                    ...
                    } else if ("香港".equals(flag) || "澳门".equals(flag)) {
                        info.setCountry("中国");
