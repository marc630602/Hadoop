...
import transformation.service.imp.DimensionConverterImpl;
...
public class TransformerOutPutFormat extends OutputFormat<BaseDimension, BaseStatsValueWritable> {
     ...
     *
     */
    public static class TransformerRecordWriter extends RecordWriter<BaseDimension, BaseStatsValueWritable> {
        ...
        public void write(BaseDimension key, BaseStatsValueWritable value) throws IOException, InterruptedException {
            ...
            try {
                ...
                if (count % Integer.parseInt(conf.get(GlobalConstants.JDBC_BATCH_NUMBER, GlobalConstants.DEFAULT_JDBC_BATCH_NUMBER)) == 0) {
                    pstmt.executeBatch();
                    conn.commit();
